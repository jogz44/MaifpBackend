...
class BillingService
{
    ...
    //     //
    // }
    // get the billing of the patient base on this transaction
    public function billing($transactionId,$request)
    {
        $user = Auth::user();
    ...
    public function update($validated, $transactionId, $request)
    {
        $user = Auth::user();
