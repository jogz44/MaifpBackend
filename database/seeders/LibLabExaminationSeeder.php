...
class LibLabExaminationSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['LAB000074', 'Blood Extraction Fee', 40.00, 4.00],
            ['LAB000008', 'Blood Indices (MCV,MCH,MCHC)', 185.00, 18.50],
            ['LAB000035', 'Blood Typing (ABO/Rh)', 62.00, 6.20],
            ['LAB000036', 'Blood Urea Nitrogen (BUN)', 185.00, 18.50],
            ['LAB000093', 'CBC with Platelet Count', 190.00, 19.00],
            ['LAB000037', 'Cholesterol', 184.00, 18.40],
            ['LAB000078', 'CK-MB', 500.00, 50.00],
            ['LAB000412', 'Clotting Time (Manual)', 75.00, 7.50],
            ['LAB000020', 'Creatinine Serum', 150.00, 15.00],
            ...
            ['LAB000413', 'ERYTHROCYTE SEDIMENTATION RATE (ESR)', 130.00, 13.00],
            ...
            ['LAB000039', 'Glucose, Random', 131.00, 13.10],
            ['LAB000049', 'Helicobacter pylori (H.pylori), Stool', 425.00, 42.50],
            ...
            ['LAB000022', 'Platelet Count', 100.00, 10.00],
            ['LAB000422', 'Pregnancy Test', 110.00, 11.00],
